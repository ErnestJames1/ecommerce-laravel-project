  ...
  <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
    <div class="relative md:flex md:items-center md:justify-between">
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden transition-all duration-300 basis-full grow md:block md:overflow-visible">
        <div class="overflow-y-auto max-h-[75vh] md:overflow-visible [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
            ...
            {{-- @auth
              <div class="hs-dropdown relative z-[9999] [--strategy:fixed] [--trigger:click] md:py-4">
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-[999] bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">
            ...
            {{-- @auth
            <div class="hs-dropdown relative z-[999] md:[--trigger:click] md:py-4">
              <button type="button"
                ...
                {{ auth()->user()->name }}
                <svg class="ms-2 w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="m6 9 6 6 6-6" />
                </svg>
              </button>

              <div class="hs-dropdown-menu hidden opacity-0 transition-[opacity,margin] duration-200 mt-2 min-w-48 z-[999] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700">
                <a href="/my-orders"
                  class="block py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
                  My Orders
                </a>
          ...
          <div x-data="{ open:false }" class="relative md:py-4">
            ...
            <div x-show="open" x-transition
              class="absolute right-0 mt-2 min-w-48 z-[999] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700">
              <a href="/my-orders" class="block py-2 px-3 rounded-lg text-sm hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">My Orders</a>
              <a href="#" class="block py-2 px-3 rounded-lg text-sm hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">My Account</a>
              <a href="/logout" class="block py-2 px-3 rounded-lg text-sm hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">Logout</a>
            </div>
          </div>
          @endauth
